...
nodes.push(new Consumer(1,"cons1",17,17));
nodes.push(new Consumer(2,"cons2",24,24));
...
// Round function
function tick(nodesList, deltaTimeInMilliseconds) {
